...
def evaluate(
    ...
    if is_primary():
        ...
        with open(os.path.join(args.log_dir, f"{task_name}_corpus_val.json"), "w") as f: 
            json.dump(corpus, f, indent=4)
        
        with open(os.path.join(args.log_dir, f"{task_name}_pred_val.json"), "w") as f:
            json.dump(candidates, f, indent=4)
        
        with open(os.path.join(args.log_dir, f"{task_name}_pred_gt_val.json"), "w") as f:
            pred_gt_val = {}
