...
class Dataset(ScanNetBaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.args.adaptive_pcd_input:
            cache_dir = 'results/process_datasets/adaptive_pcds_adapt_scale_1w/scanqa'
            ...
            if uni_key in exist_npy:
                ...
                ret_dict['point_clouds'], ret_dict['sample_prob'] = dense_pointclouds(dense_ret_dict["point_clouds"], dense_ret_dict["instance_labels"], self.annotations[idx]['object_ids'],object_size, object_num)
