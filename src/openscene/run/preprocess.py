...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    from dataset.preprocess_loader import FusedFeatureLoader, collation_fn_eval_all
...
def evaluate(model, val_data_loader, labelset_name='scannet_3d'):
    ...
    with torch.no_grad():
        ...
        for rep_i in range(args.test_repeats):
            ...
            for i, (coords, feat, label, feat_3d, mask, inds_reverse, locs_in, scan_name) in enumerate(tqdm(val_data_loader)):
                ...
                if feature_type == 'distill':
                    ...
                    op_dir = f'/mnt/nfs/share/Adaptive/openscene_dense_fts_distill_axis_align'
